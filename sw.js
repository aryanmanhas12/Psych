...
/* Bump this on every release that changes a cached file. Pages (HTML) are
   ...
   v8: i18n.js is gone, replaced by i18n.<lang>.js — all six are listed
   ...
   whole saving; but an installed copy has to keep switching language
   with no network at all, and that only works if every one of them was
